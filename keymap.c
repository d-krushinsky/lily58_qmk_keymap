...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
      ...
      KC_LALT, KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_LBRC,      KC_RBRC, KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_EQL ,
                        KC_LGUI, KC_LSFT, MO(1)  , KC_SPC ,                        KC_ENT , MO(2)  , KC_RSFT, KC_RALT
    ),
    [_LOWER] = LAYOUT(
      KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  ,                        KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_TRNS,
      KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11 , KC_F12 ,                        KC_EQL , KC_LBRC, KC_RBRC, KC_NO  , KC_NO  , KC_NO  ,
      KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_BRIU, KC_BRID,                        KC_PLUS, KC_LCBR, KC_RCBR, KC_NO  , KC_NO  , KC_NO  ,
      KC_TRNS, KC_NO  , KC_NO  , KC_MPLY, KC_MPRV, KC_MNXT, KC_TILD,      KC_DEL , KC_PIPE, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,
                        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, MO(3)  , KC_TRNS, KC_TRNS
    ),
    [_RAISE] = LAYOUT(
      KC_TRNS, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_CAPS,                        KC_PSCR, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_TRNS,
      KC_TRNS, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,                        KC_NO  , KC_HOME, KC_END , KC_NO  , KC_NO  , KC_NO  ,
      KC_TRNS, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  ,                        KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_NO  , KC_NO  ,
      KC_TRNS, KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_GRV ,      KC_BSLS, KC_NO  , KC_PGDN, KC_PGUP, KC_NO  , KC_NO  , KC_NO  ,
